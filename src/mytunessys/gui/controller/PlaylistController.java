...
public class PlaylistController {
    ...
    public void displayedDeleteConfirmation(Playlist playlistToDelete) {
        ...
        if (confirm.get().equals(ButtonType.OK)) {
            try {
                ...
                fillTable();
                AlertNotification.showAlertWindow("Playlist with id : " + playlistToDelete.getId() + " was successfully updated !",
    ...
    /**
     * Creates a new popup window, depending on what we do (edit/create) it displays the content accordingly and uses updatePlaylist/createPlaylist
     *
     * @param content Must be a Playlist.
     */
            ...
            public void handle(ActionEvent event) {
                try {
                    if (editing) {
                        ...
                        fillTable();
                        AlertNotification.showAlertWindow("Successfully created playlist with id : " + playlistName.getId() + " !",
                            Alert.AlertType.INFORMATION);
                    }
                } catch (Exception e) {
                    throw new RuntimeException(e);
